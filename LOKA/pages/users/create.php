...
<div class="container-fluid py-4">
    <div class="mb-4">
        ...
        <nav aria-label="breadcrumb"><ol class="breadcrumb mb-0"><li class="breadcrumb-item"><a href="<?= APP_URL ?>">Dashboard</a></li><li class="breadcrumb-item"><a href="<?= APP_URL ?>/?page=users">Users</a></li><li class="breadcrumb-item active">Add</li></ol></nav>
    </div>
    
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header"><h5 class="mb-0"><i class="bi bi-person-plus me-2"></i>User Details</h5></div>
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" name="email" value="<?= e(post('email', '')) ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Password <span class="text-danger">*</span></label>
                                <input type="password" class="form-control" name="password" required minlength="<?= PASSWORD_MIN_LENGTH ?>">
                                <small class="text-muted"><?= e($security->getPasswordRequirements()) ?></small>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Phone</label>
                                <input type="text" class="form-control" name="phone" value="<?= e(post('phone', '')) ?>">
                            </div>
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="role" required>
                                    ...
                                    <option value="<?= $key ?>" <?= post('role') === $key ? 'selected' : '' ?>><?= e($info['label']) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-md-6">
