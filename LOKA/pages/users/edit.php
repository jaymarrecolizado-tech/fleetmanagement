...
<div class="container-fluid py-4">
    <div class="mb-4">
        ...
        <nav aria-label="breadcrumb"><ol class="breadcrumb mb-0"><li class="breadcrumb-item"><a href="<?= APP_URL ?>">Dashboard</a></li><li class="breadcrumb-item"><a href="<?= APP_URL ?>/?page=users">Users</a></li><li class="breadcrumb-item active">Edit</li></ol></nav>
    </div>
    
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header"><h5 class="mb-0"><i class="bi bi-pencil me-2"></i>Edit User</h5></div>
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" name="email" value="<?= e(post('email', $user->email)) ?>" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="department_id">
                                    ...
                                    <option value="<?= $dept->id ?>" <?= post('department_id', $user->department_id) == $dept->id ? 'selected' : '' ?>><?= e($dept->name) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
