...
### COMPLIANCE AUDIT UPDATES (2026-01-23)

**Additional Fixes Applied:**
- ✅ Fix #12: Transaction Nesting Check - Added `inTransaction()` to Database class and `dbInTransaction()` helper
- ✅ Fix #13: Atomic notifyPassengers() - Wrapped in transaction with proper rollback
